	...
	{#if isEditing}
		...
		>
			<div class="relative">
				...
				/>
				<div
					class="absolute pointer-events-none top-1/2 left-1/2 space-y-2 text-center -translate-x-1/2 -translate-y-1/2"
				>
			...
			<p class="mt-4 text-muted-foreground text-xs">Recommended aspect ratio - 16:9</p>
		</form>
	{:else if imageUrl}
